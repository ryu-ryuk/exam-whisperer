		...
		<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
			...
			<nav className="fixed top-0 w-full z-50 bg-black/20 backdrop-blur-md border-b border-white/10">
				<div className="container mx-auto px-4 py-4 flex justify-between items-center">
					...
					<Button className="bg-purple-600 hover:bg-purple-700 text-white">Try Now</Button>
				</div>
			</nav>
			...
			<section id="ask-anything" className="py-20 bg-black/20">
			...
			{/* Quiz Mode Section */}
			<section id="quiz-mode" className="py-20">
				<div className="container mx-auto px-4">
					<div className="grid lg:grid-cols-2 gap-12 items-center">
			...
			<section id="learning-tracker" className="py-20 bg-black/20">
				<div className="container mx-auto px-4">
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<div>
